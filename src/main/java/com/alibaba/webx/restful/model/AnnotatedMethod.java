...
final class AnnotatedMethod implements AnnotatedElement {
    ...
    @SuppressWarnings("unchecked")
    private static final Set<Class<? extends Annotation>> METHOD_ANNOTATIONS      = getSet(Path.class, Produces.class,
                                                                                           Consumes.class);
    @SuppressWarnings("unchecked")
    private static final Set<Class<? extends Annotation>> PARAMETER_ANNOTATIONS   = getSet(Context.class,
                                                                                           Encoded.class,
                                                                                           DefaultValue.class,
                                                                                           MatrixParam.class,
                                                                                           QueryParam.class,
    ...
    /**
     * Get method parameter types. See also {@link Method#getParameterTypes()}.
     * 
    ...
    /**
     * Get method type parameters. See also {@link Method#getTypeParameters()}.
     * 
    ...
    /**
     * Get generic method parameter types. See also {@link Method#getGenericParameterTypes()}.
     * 
     ...
     * @return meta-annotation instances of a given type annotating the method annotations.
     */
    ...
    private static Method findAnnotatedMethod(Class<?> c, Method m) {
        ...
        m = ReflectionUtils.findMethodOnClass(c, m);
        if (m == null) {
            return null;
        }
