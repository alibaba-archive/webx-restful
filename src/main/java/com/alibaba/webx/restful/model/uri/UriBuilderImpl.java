...
public class UriBuilderImpl extends UriBuilder {
    ...
    private UriBuilderImpl(UriBuilderImpl that){
        ...
        this.matrixParams = that.matrixParams == null ? null : new MultivaluedHashMap<String, String>(that.matrixParams);
        this.query = new StringBuilder(that.query);
        this.queryParams = that.queryParams == null ? null : new MultivaluedHashMap<String, String>(that.queryParams);
    ...
    private URI _buildFromMap(boolean encode, Map<String, ? extends Object> values) {
        ...
        String uri = UriTemplate.createURI(scheme, authority, userInfo, host, port, path.toString(), query.toString(),
