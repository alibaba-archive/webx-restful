...
public class UriComponent {
     ...
     * @param t the URI compontent type identifying the ASCII characters that must be percent-encoded.
     ...
     * 
     * @param u the URI.
     * @param decode true if the query parameters of the query component should be in decoded form.
     ...
     * @param decode true of the query parameters of the query component should be in decoded form.
     * @return the multivalued map of query parameters.
     */
    ...
    private static void decodeQueryParam(MultivaluedMap<String, String> params, String param, boolean decode) {
        try {
            ...
            if (equals > 0) {
                params.add(URLDecoder.decode(param.substring(0, equals), "UTF-8"),
    ...
    public static void decodePathSegment(List<PathSegment> segments, String segment, boolean decode) {
        ...
        if (colon != -1) {
            segments.add(new PathSegmentImpl((colon == 0) ? "" : segment.substring(0, colon), decode,
    ...
    public static MultivaluedMap<String, String> decodeMatrix(String pathSegment, boolean decode) {
        MultivaluedMap<String, String> matrixMap = new MultivaluedHashMap<String, String>();
    ...
    private static int decodeHex(String s, int i) {
        ...
        if (v == -1) {
            throw new IllegalArgumentException("illegal hex char : " + s.charAt(i));
        }
        return v;
    }
